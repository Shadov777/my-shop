  ...
  return (
    ...
    >
      <button
        ...
        className={cn(
          "pointer-events-auto h-fit w-fit rounded-full bg-zinc-800 p-2 transition-opacity duration-300 dark:bg-zinc-800",
      ...
      >
        <ChevronLeft className="stroke-zinc-100 dark:stroke-zinc-100" size={16} />
      </button>
      <button
        type="button"
        className={cn(
      ...
      >
        <ChevronRight className="stroke-zinc-100 dark:stroke-zinc-100" size={16} />
      </button>
    </div>
  )
}
        ...
        {Array.from({ length: itemsCount }, (_, i) => (
          <button
            ...
            className={cn(
              ...
              index === i ? "bg-zinc-100 dark:bg-zinc-100" : "bg-zinc-500/50 dark:bg-zinc-500/50",
              classNameButton,
            )}
          />
        ))}
